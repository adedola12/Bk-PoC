...
/**
 * Review queue item â€” one per flagged field/row. Stores the reviewer's
 * resolution so every human correction becomes calibration data (Â§9).
 */
