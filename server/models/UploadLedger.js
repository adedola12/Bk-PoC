...
/**
 * Upload Ledger â€” one document per uploaded file. Identity backbone for D4
...
const triageSchema = new mongoose.Schema(
  {
    ...
    // D11 â€” non-product routes require human confirmation before filing
...
export const UploadLedger = mongoose.model("UploadLedger", uploadLedgerSchema);
