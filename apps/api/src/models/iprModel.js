...
/**
 * Intermediate Product Record (Design Doc §3 Stage 2). Every field, without
...
const iprSchema = new mongoose.Schema(
  {
    ...
    // free-form typed attributes: key → IPR field
    ...
    // classification (Stage 4) and variant lineage (Stage 6) — filled later
